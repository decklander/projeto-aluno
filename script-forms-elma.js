...
const availableTimes = {
    0: generateTimes('08:00', '10:40').concat(generateTimes('18:30', '21:40')),
    1: generateTimes('18:30', '19:40'),
    2: generateTimes('10:00', '11:40').concat(generateTimes('20:50', '21:50')),
    3: generateTimes('10:00', '11:40'),
    4: generateTimes('08:00', '10:40').concat(generateTimes('18:30', '21:40')),
};
